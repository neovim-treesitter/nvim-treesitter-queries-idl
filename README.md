# nvim-treesitter-queries-idl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-idl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-idl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **idl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-idl",
...
- [ ] Changes are scoped to `idl` — do not include files for other languages
